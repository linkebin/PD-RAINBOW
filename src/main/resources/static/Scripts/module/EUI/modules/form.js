/** eui-v2.0.0 MIT License By http://www.eui.com */
;
eui.define("layer",
    function(e) {
     "use strict";
               ...
               radio: function() {
                ...
                a.each(function(a, l) {
                 var s = i(this),
                     ...
                     u = this.disabled;
                 if ("string" == typeof s.attr("e-ignore")) return s.show();
                 var o = i(['<div class="eui-unselect ' + e + (l.checked ? " " + e + "ed": "") + (u ? " eui-radio-disbaled " + c: "") + '">', '<i class="eui-anim eui-icon">' + t[l.checked ? 0 : 1] + "</i>", "<span>" + (l.title || "未命名") + "</span>", "</div>"].join(""));
                 r[0] && r.remove(),
                     s.after(o),
                     n.call(this, o)
                })
