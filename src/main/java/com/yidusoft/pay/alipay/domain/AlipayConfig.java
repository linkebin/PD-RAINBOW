...
public class AlipayConfig {
    ...
    public static String NOTIFY_URL = "http://192.168.1.101:8088/alipay/notify/notifyUrl";
    ...
    public static String RETURN_URL = "http://192.168.1.101:8088/alipay/notify/returnUrl";
