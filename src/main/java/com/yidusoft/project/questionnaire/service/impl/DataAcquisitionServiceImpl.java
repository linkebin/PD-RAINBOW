...
public class DataAcquisitionServiceImpl extends AbstractService<DataAcquisition> implements DataAcquisitionService {
    ...
    public String symptomConclusion(String acquisitionId, String userId) {
        ...
        map1.put("factorMean","");
        map1.put("factor",factor2);
        factor.put("2",map2);
        Map<String,Object> map3=new  HashMap<>();
        map1.put("factorMean","");
        map1.put("factor",factor3);
        factor.put("3",map3);
        Map<String,Object> map4=new  HashMap<>();
        map1.put("factorMean","");
        map1.put("factor",factor4);
        factor.put("4",map4);
        Map<String,Object> map5=new  HashMap<>();
        map1.put("factorMean","");
        map1.put("factor",factor5);
        factor.put("5",map5);
        Map<String,Object> map6=new  HashMap<>();
        map1.put("factorMean","");
        map1.put("factor",factor6);
        factor.put("6",map6);
        Map<String,Object> map7=new  HashMap<>();
        map1.put("factorMean","");
        map1.put("factor",factor7);
        factor.put("7",map7);
        Map<String,Object> map8=new  HashMap<>();
        map1.put("factorMean","");
        map1.put("factor",factor8);
        factor.put("8",map8);
        Map<String,Object> map9=new  HashMap<>();
        map1.put("factorMean","");
        map1.put("factor",factor9);
        factor.put("9",map9);
        Map<String,Object> map10=new  HashMap<>();
        map1.put("factorMean","");
        map1.put("factor",factor10);
        factor.put("10",map10);
