...
public interface QuestionnaireMapper extends Mapper<Questionnaire> {
    ...
    List<Map<String,Object>> findQuestionnaireUsedCountByWeekMAndY();

    List<Map<String,Object>> findQuestionnaireUsedCountByMonth();

    List<Map<String,Object>> findAllQuestionnaireUsedCount();
}